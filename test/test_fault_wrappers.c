...
#else
    static const int errors[] = {EBADF, EINPROGRESS, EINTR, EINVAL, EIO};
#endif
...
{
#ifdef __linux__
    static const int errors[] = {EBADF, EBUSY, EINTR, EINVAL, EMFILE, ENOMEM};
#elif defined(__APPLE__)
    static const int errors[] = {EBADF, EINTR, EMFILE};
#elif defined(__FreeBSD__)
    static const int errors[] = {EBADF, EMFILE};
#else
    static const int errors[] = {EBADF, EINTR, EINVAL, EIO, EMFILE};
#endif
...
{
#ifdef __linux__
    static const int errors[] = {EFAULT, EINTR, EINVAL, ENOMEM};
#elif defined(__APPLE__)
...
static void test_p101_pread(struct p101_env *env, struct p101_error *err)
{
    ...
    static const int errors[] = {EIO};
#elif defined(__APPLE__)
    static const int errors[] = {EAGAIN, EBADF, ECONNRESET, EDEADLK, EFAULT, EINTR, EINVAL, EIO, EISDIR, ENOBUFS, ENOMEM, ENOTCONN, ENXIO, ESPIPE, ESTALE, ETIMEDOUT};
#elif defined(__FreeBSD__)
    static const int errors[] = {EAGAIN, EBADF, EBUSY, ECONNRESET, EFAULT, EINTR, EINVAL, EIO, EISDIR, EOPNOTSUPP, EOVERFLOW, ESPIPE};
#else
    static const int errors[] = {EAGAIN, EBADF, ECONNRESET, EINTR, EINVAL, EIO, EISDIR, ENOBUFS, ENOMEM, ENOTCONN, ENXIO, EOVERFLOW, ESPIPE, ETIMEDOUT, EWOULDBLOCK};
#endif
...
static void test_p101_pwrite(struct p101_env *env, struct p101_error *err)
{
    ...
    static const int errors[] = {EAGAIN, EBADF, EDESTADDRREQ, EDQUOT, EFAULT, EFBIG, EINTR, EINVAL, EIO, ENOBUFS, ENOSPC, EPIPE, ESPIPE};
#else
    static const int errors[] = {EACCES, EAGAIN, EBADF, ECONNRESET, EFBIG, EINTR, EINVAL, EIO, ENETDOWN, ENETUNREACH, ENOBUFS, ENOSPC, ENXIO, EPIPE, ESPIPE, EWOULDBLOCK};
#endif
...
{
#ifdef __linux__
    static const int errors[] = {EINVAL, EOPNOTSUPP};
#elif defined(__APPLE__)
    static const int errors[] = {EAGAIN, EBADF, ECONNRESET, EDEADLK, EFAULT, EINTR, EINVAL, EIO, EISDIR, ENOBUFS, ENOMEM, ENOTCONN, ENXIO, ESPIPE, ESTALE, ETIMEDOUT};
#elif defined(__FreeBSD__)
    static const int errors[] = {EAGAIN, EBADF, EBUSY, ECONNRESET, EFAULT, EINTR, EINVAL, EIO, EISDIR, EOPNOTSUPP, EOVERFLOW, ESPIPE};
